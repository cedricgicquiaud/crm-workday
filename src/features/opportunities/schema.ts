...
export const OPPORTUNITY_FIELDS: readonly FieldDescriptor[] = [
  ...
  { key: "companyId", label: "Entreprise", type: "relation", required: true, sortable: true, order: 20 },
  { key: "contactPersonId", label: "Contact", type: "relation", sortable: true, order: 30 },
