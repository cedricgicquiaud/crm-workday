...
| **Contact** | Nom, poste, email, téléphone, LinkedIn, rôle dans la décision (décideur, acheteur, utilisateur). | Entreprise, opportunités, activités. |
| **Lead** | Origine (LinkedIn, recommandation, appel d'offres, partenaire), statut (nouveau, contacté, qualifié, écarté), score. | Converti en contact + entreprise + opportunité. |
