...
- [ ] « Inviter » avec un email mal formé (`pas-un-email`) ou un prénom vide : le dialogue reste ouvert avec le message « Email, prénom, nom et rôle sont requis. ».
...
- [ ] Sur `/profil`, formulaire « Mot de passe » : mot de passe actuel `MotDePasse-Ines-1`, nouveau `Court-Mdp-1` deux fois, « Changer le mot de passe » : « Le mot de passe doit contenir 12 caractères au moins. » (contrat 13). Nouveau `MotDePasse-Ines-2` et confirmation `MotDePasse-Ines-3` : « Les deux mots de passe ne sont pas identiques. ». Actuel `MotDePasse-Faux-1`, nouveau et confirmation `MotDePasse-Ines-2` : « Le mot de passe actuel est incorrect. ».
