 ...
 */
const MECHANISM_DIRS = ["src/features/objects", "src/features/history"];
...
describe("les mécanismes ne citent aucun objet (CRM-33, D4)", () => {
  it("aucun fichier de src/features/objects et src/features/history, hors registre et manifeste, ne contient « company » ni « person »", () => {
