...
describe("les mécanismes ne citent aucun objet (CRM-33, D4)", () => {
  it("aucun fichier des mécanismes — objets, historique, activités, archivage, champs personnalisés, vues, doublons, fusion — hors registre et manifeste, ne contient « company » ni « person »", () => {
